...
class DeyeInverter:
    ...
    def _read_1p_data_unlocked(self, battery_sampler=None) -> dict:
        ...
        try:
            ...
            data["load_daily_power"] = self.read_register(526)
            time.sleep(0.05)
            ...
            time.sleep(0.05)
            data["load_l1"] = to_signed(self.read_register(176))
            time.sleep(0.05)
    ...
    def _read_3p_data_unlocked(self, battery_sampler=None) -> dict:
        ...
        try:
            ...
            #data["grid_power"] = to_signed(raw_grid_power)
            data["grid_power"] = to_signed((self.read_register(690) << 16) | self.read_register(625))
            time.sleep(0.05)
            ...
            if self.config.phases == 3:
                data["load_l1"] = to_signed(self.read_register(650))
                time.sleep(0.05)
                data["load_l2"] = to_signed( self.read_register(651))
                time.sleep(0.05)
                data["load_l3"] = to_signed( self.read_register(652))
                time.sleep(0.05)
